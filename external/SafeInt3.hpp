...
public:
    ...
    constexpr static T maxInt = static_cast<T>(SafeIntMinMax< isSigned, bitCount >::max);
    constexpr static T minInt = static_cast<T>(SafeIntMinMax< isSigned, bitCount >::min);
};
